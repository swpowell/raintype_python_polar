...
#Reflectivity sweep to base rain-type map on (zero-based 0 = 0.5 deg for SPOL or 0.8 deg for Revelle)
sweep_used = 0
...
fileDir = '/home/disk/anvil2/spowell/Raintype_Distribute/python/Polar/in/SMART-R/20111016/';
fileDirOut = '/home/disk/anvil2/spowell/Raintype_Distribute/python/Polar/out/SMART-R/';

title = 'Rain type classification of DYNAMO SPolKa radar data in polar coordinates';
institution = 'University of Washington';
source = 'Code used https://github.com/swpowell/raintype_polar';
...
for m in range(0,1):#numfiles): #range(1431,1432):
